...
t4 = -(12*u^2*vf^2 - 12*u^2*v0^2 + 8*a0^3*am - 8*af^3*am - 3*a0^4 + 3*af^4 - 6*a0^2*am^2 + 6*af^2*am^2 + 12*a0^2*u*v0 + 12*am^2*u*v0 + 12*af^2*u*vf + 12*am^2*u*vf + 24*am^2*u*vm + 24*am*u^2*x0 - 24*am*u^2*xf - 24*a0*am*u*v0 - 24*af*am*u*vf)/(24*am*u^2*vm);
