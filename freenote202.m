...
v1_ = v0  + a0*t1_ + 1/2*u*t1_^2;
v2_ = v1_ + a1_*t2_ - 1/2*u*t2_^2;
v3_ = v2_ + a2_*t3_ + 1/2*u*t3_^2;

x1_ = x0  + v0*t1_ + 1/2*a0*t1_^2 + 1/6*u*t1_^3;
x2_ = x1_ + v1_*t2_ + 1/2*a1_*t2_^2 - 1/6*u*t2_^3;
x3_ = x2_ + v2_*t3_ + 1/2*a2_*t3_^2 + 1/6*u*t3_^3;

chad = simplify(v3_-v3);
...
chad = v0 + a0*t1 + (t1^2*u)/2 - (t2^2*u)/2  + t2*(a0 + t1*u)
A = u/2;
B = (a0 + t1*u - t2*u);
C = v0 + a0*t1 + (t1^2*u)/2 - (t2^2*u)/2  + t2*(a0 + t1*u);
